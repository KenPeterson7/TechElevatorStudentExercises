...
/**
 * 
 * This is text to describe what this method does. This
 * named function takes in 3 parameters. It will return
 * the converted temperature in a string format.
 * 
 * @param {number} temperature test temp text
 * @param {string} temperatureUnit test temperature unit text
 * @param {boolean} includeUnit test boolean text
 * @returns 
 */
