...
select count(site_number) as sum_site from site where utilities = true;
...
select reservation_id, site_id, name, from_date, to_date from reservation where from_date between '2022-08-01' and '2022-08-31';
...
select count(reservation_id) as total_number from reservation;
