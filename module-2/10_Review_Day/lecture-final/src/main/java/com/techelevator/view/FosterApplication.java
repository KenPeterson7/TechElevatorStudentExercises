...
/*        Puppy newPuppy = new Puppy("Mr. Toad", 27, "male",
        ...
        //Updating then removing a Puppy
        /*Puppy newPuppy = new Puppy(5,"Mr. Toad", 35, "M",
                "Pug", false);
         Puppy retrievedPuppy = dao.updatePuppy(newPuppy);
        dao.removePuppy(newPuppy.getPuppyId());
        System.out.println(newPuppy.getPuppyName() +
                " has been deleted from the data source!");*/
    }
}
