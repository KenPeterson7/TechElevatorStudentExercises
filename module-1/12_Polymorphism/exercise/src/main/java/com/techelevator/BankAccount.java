...
public class BankAccount implements Accountable {
    ...
    public int transferTo(BankAccount destinationAccount, int transferAmount){
        ...
        if(newBalance < 0) {
            ...
            //so it takes the balance and subtracts the amount to withdrawal (transfer amount) and stores it in this instance of this withdraw
            ...
            //so it takes the balance and adds the amount to withdrawal (transfer amount), and stores it in destinationAccount
